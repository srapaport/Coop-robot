...
do
    ...
    do
        ...
        /usr/bin/time -a -o ../logs/log-time-phiUltimate24/log_algov5_${taille}_${robot}.txt python3 ../src/main.py 5 $robot $taille >> ../logs/log-time-phiUltimate24/log_algov5_${taille}_${robot}.txt &
    done

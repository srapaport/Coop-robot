...
data = pd.read_csv('./data/data-phiUltimate24/data-timev2.csv', sep=';')
...
ax.grid()
ax.legend()
fig.savefig("./data/data-phiUltimate24/compar_phiUltimate24_2.png")
plt.show()
################# 3
fig, ax = plt.subplots()
...
ax.grid()
ax.legend()
fig.savefig("./data/data-phiUltimate24/compar_phiUltimate24_3.png")
plt.show()
################# 4
fig, ax = plt.subplots()
...
ax.grid()
ax.legend()
fig.savefig("./data/data-phiUltimate24/compar_phiUltimate24_4.png")
plt.show()
################# 5
fig, ax = plt.subplots()
...
ax.grid()
ax.legend()
fig.savefig("./data/data-phiUltimate24/compar_phiUltimate24_5.png")
plt.show()

...
def mainv5(taille_anneau, nb_robots):
        # if nb_robots%2 == 0:
        #         disoriented = (factorial(taille_anneau+(nb_robots/2)-1)//(factorial((nb_robots/2))*factorial(taille_anneau-1)))  
        # else:
        #         disoriented = (factorial(taille_anneau+((nb_robots-1)/2)-1)//(factorial(((nb_robots-1)/2))*factorial(taille_anneau-1)))
        # oriented = (factorial(taille_anneau+(nb_robots-1)-1)//(factorial(nb_robots-1)*factorial(taille_anneau-1))) - disoriented

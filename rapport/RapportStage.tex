...
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.7\textwidth]{../data/data-phiSM/compar_phiSM_2.png}\label{phiSMr2}
    \caption{Results for 2 robots}
\end{figure}

\begin{figure}[!h]
    \centering
    \includegraphics[width=0.7\textwidth]{../data/data-phiSM/compar_phiSM_3.png}\label{phiSMr3}
    \caption{Results for 3 robots}
\end{figure}

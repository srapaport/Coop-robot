...
\begin{figure}[!h]
    \centering
    \subfloat[][]{\includegraphics[width=0.5\textwidth]{../data/data-phiSimple/compar_phiSimple_2.png}\label{phiSimpler2}}
    \subfloat[][]{\includegraphics[width=0.5\textwidth]{../data/data-phiSimple/compar_phiSimple_3.png}\label{phiSimpler3}}
...
\begin{figure}[!h]
    \centering
    \subfloat[][]{\includegraphics[width=0.5\textwidth]{../data/data-phiSM/compar_phiSM_2.png}\label{phiSMr2}}
    \subfloat[][]{\includegraphics[width=0.5\textwidth]{../data/data-phiSM/compar_phiSM_3.png}\label{phiSMr3}}
    \caption{Results for 2 (a) \& 3 (b) robots}
\end{figure}

\begin{figure}[!h]
    \centering
    \subfloat[][]{\includegraphics[width=0.5\textwidth]{../data/data-phiSM/compar_phiSM_4.png}\label{phiSMr4}}
    \subfloat[][]{\includegraphics[width=0.5\textwidth]{../data/data-phiSM/compar_phiSM_5.png}\label{phiSMr5}}
